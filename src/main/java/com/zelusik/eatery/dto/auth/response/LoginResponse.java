...
public class LoginResponse {
    ...
    public static LoginResponse from(MemberDto memberDto, @Nullable TermsInfoDto termsInfoDto, TokenDto tokenDto) {
        return new LoginResponse(LoggedInMemberResponse.from(memberDto, termsInfoDto), TokenResponse.from(tokenDto));
    }
