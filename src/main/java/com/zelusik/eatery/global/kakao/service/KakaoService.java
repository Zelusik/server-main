package com.zelusik.eatery.global.kakao.service;
...
import com.zelusik.eatery.global.kakao.exception.KakaoServerException;
...
public class KakaoService {
    ...
    public Slice<KakaoPlaceInfo> searchKakaoPlacesByKeyword(String keyword, Pageable pageable) {
        URI requestUri = UriComponentsBuilder
        ...
        List<KakaoPlaceInfo> content = documents.stream()
                .map(KakaoPlaceInfo::from)
                .toList();
