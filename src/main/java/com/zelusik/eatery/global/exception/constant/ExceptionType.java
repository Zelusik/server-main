...
import com.zelusik.eatery.domain.member.exception.ProfileImageNotFoundException;
import com.zelusik.eatery.domain.place.entity.Place;
import com.zelusik.eatery.domain.place.exception.*;
import com.zelusik.eatery.domain.review.entity.Review;
import com.zelusik.eatery.domain.review.exception.*;
...
import com.zelusik.eatery.global.exception.GlobalExceptionHandler;
...
import com.zelusik.eatery.global.kakao.exception.KakaoTokenValidateException;
import com.zelusik.eatery.global.kakao.exception.OpenAIServerException;
...
public enum ExceptionType {
    ...
    THUMBNAIL_IMAGE_CREATE(1002, "이미지 압축 과정에서 알 수 없는 에러가 발생했습니다.", ThumbnailImageCreationException.class),
