...
public enum ReviewKeywordValue {
    ...
    FRESH(ReviewKeywordType.FOOD_PRICE, "신선한 재료", "신선한 재료"),
    BEST_FLAVOR(ReviewKeywordType.FOOD_PRICE, "최고의 맛", "최고의 맛"),
    BEST_MENU_COMBINATION(ReviewKeywordType.FOOD_PRICE, "완벽 메뉴 조합", "완벽한 메뉴 조합"),
    LOCAL_FLAVOR(ReviewKeywordType.FOOD_PRICE, "현지 느낌 가득", "현지 느낌이 가득한"),
    GOOD_PRICE(ReviewKeywordType.FOOD_PRICE, "가성비 갑", "가성비가 좋은"),
    GENEROUS_PORTIONS(ReviewKeywordType.FOOD_PRICE, "넉넉한 양", "넉넉한 양"),

    WITH_ALCOHOL(ReviewKeywordType.VIBE, "술과 함께", "술과 함께하기 좋은"),
    GOOD_FOR_DATE(ReviewKeywordType.VIBE, "데이트에 최고", "데이트 하기에 좋은"),
    WITH_ELDERS(ReviewKeywordType.VIBE, "웃어른과", "웃어른과 함께하기 좋은"),
    CAN_ALONE(ReviewKeywordType.VIBE, "혼밥 가능", "혼밥 가능한"),
    PERFECT_FOR_GROUP_MEETING(ReviewKeywordType.VIBE, "단체모임에 딱", "단체 모임에 좋은"),
    WAITING(ReviewKeywordType.VIBE, "웨이팅 있음", "웨이팅 있는"),
    SILENT(ReviewKeywordType.VIBE, "조용조용한", "조용조용한"),
    NOISY(ReviewKeywordType.VIBE, "왁자지껄한", "왁자지껄한"),
    ;
