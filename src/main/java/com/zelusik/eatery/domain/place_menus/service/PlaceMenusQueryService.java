...
public class PlaceMenusQueryService {
    ...
    public PlaceMenusDto findDtoByPlaceId(@NonNull Long placeId) {
        PlaceMenus placeMenus = placeMenusRepository.findByPlace_Id(placeId).orElseThrow(() -> new PlaceMenusNotFoundException(placeId));
    ...
    public PlaceMenusDto findDtoByKakaoPid(@NonNull String kakaoPid) {
        PlaceMenus placeMenus = placeMenusRepository.findByPlace_KakaoPid(kakaoPid).orElseThrow(() -> new PlaceMenusNotFoundException(kakaoPid));
        return PlaceMenusDto.from(placeMenus);
    }
}
